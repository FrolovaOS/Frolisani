...
public class Adapter extends RecyclerView.Adapter<Adapter.RepViewHolder> {
  ...
  public Adapter() {
    sortedList =
        new SortedList<>(
            Own_Recipes.class,
            new SortedList.Callback<Own_Recipes>() {
  ...
  @NonNull
  @Override
  public com.example.Recipes.screens.OwnRecipes.Adapter.RepViewHolder onCreateViewHolder(
  ...
  public void onBindViewHolder(
      @NonNull com.example.Recipes.screens.OwnRecipes.Adapter.RepViewHolder holder, int position) {
