...
public  class Adapter_product extends RecyclerView.Adapter<Adapter_product.ProductViewHolder> {
    ...
    public ProductViewHolder onCreateViewHolder( ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_of_fridg, parent, false);
    ...
    public  class ProductViewHolder extends RecyclerView.ViewHolder {
        ...
        public ProductViewHolder(View view) {
            ...
            IsExit.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    ...
                    if(IsExit.isChecked()) {
                        ...
                        db.update("app_product", cv, "product_id = ?",
